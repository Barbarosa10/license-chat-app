...
# def get_data():
#     df = pd.read_csv("./chat_dataset.csv", names=["message", "sentiment"])
#     # print(df.head())
...
#     # train_text, temp_text, train_labels, temp_labels = train_test_split(df['message'], df['sentiment'], 
#     #                                                                 random_state=2018, 
#     #                                                                 test_size=0.3, 
#     #                                                                 stratify=df['sentiment'])

#     # validation_text, test_text, validation_labels, test_labels = train_test_split(temp_text, temp_labels, 
#     #                                                             random_state=2018, 
#     #                                                             test_size=0.5, 
...
class IMDBBertDataset(Dataset):
    ...
    def __init__(self, path, ds_from=None, ds_to=None, should_include_text=False):
        self.ds: pd.Series = pd.read_csv(path, names=["message", "sentiment"])['message']
...
if __name__ == '__main__':
    ...
    ds = IMDBBertDataset('./imdb_dataset.csv', ds_from=0, ds_to=50000,
